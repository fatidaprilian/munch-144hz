...
doze_hbm = bytes.fromhex("05 01 00 00 00 00 02 28 00 39 00 00 00 00 00 03 f0 5a 5a 39 00 00 00 00 00 02 60 00 39 00 00 00 00 00 03 fc 5a 5a 39 00 00 00 00 00 02 b0 16 39 00 00 00 00 00 02 d1 10 39 00 00 00 00 00 03 fc a5 a5 39 00 00 00 00 00 02 b0 0b 39 00 00 00 00 00 03 d8 50 00 39 00 00 00 00 00 02 53 22 39 01 00 00 22 00 03 f0 a5 a5 05 01 00 00 00 00 02 29 00")
t2_bytes += make_fdt_prop("mi,mdss-dsi-doze-hbm-command", doze_hbm)
doze_lbm = bytes.fromhex("05 01 00 00 00 00 02 28 00 39 00 00 00 00 00 03 f0 5a 5a 39 00 00 00 00 00 02 60 00 39 00 00 00 00 00 03 fc 5a 5a 39 00 00 00 00 00 02 b0 16 39 00 00 00 00 00 02 d1 10 39 00 00 00 00 00 03 fc a5 a5 39 00 00 00 00 00 02 b0 0b 39 00 00 00 00 00 03 d8 50 00 39 00 00 00 00 00 02 53 23 39 01 00 00 22 00 03 f0 a5 a5 05 01 00 00 00 00 02 29 00")
...
flat_on = bytes.fromhex("39 01 00 00 00 00 03 f0 5a 5a 39 00 00 00 00 00 1d c2 2d 27 fe 82 c6 70 82 70 ca 0a 0a 0a 28 28 28 35 35 35 3f 3f 3f 42 42 42 1b da 2f 48 39 00 00 00 00 00 02 f7 03 39 01 00 00 09 00 03 f0 a5 a5")
t2_bytes += make_fdt_prop("mi,mdss-dsi-flat-on-command", flat_on)
flat_off = bytes.fromhex("39 01 00 00 00 00 03 f0 5a 5a 39 00 00 00 00 00 1d c2 2d 07 fe 82 c6 70 82 70 ca 0a 0a 0a 28 28 28 35 35 35 3f 3f 3f 42 42 42 1b da 2f 48 39 00 00 00 00 00 02 f7 03 39 01 00 00 09 00 03 f0 a5 a5")
